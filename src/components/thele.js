    ...
    <div className='main2'>
        ...
        <div className="content">
            ...
            <button className='xemthem'>
              <span  className='the-le-redirect'><a href='https://drive.google.com/file/d/1quxjtueBl8yOKO-q0CJ-hh0vt-cMwlE-/view?usp=sharing' target="_blank">Xem thêm</a></span></button>
